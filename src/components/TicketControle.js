  ...
  return (
    <div className="ticket-container">
      ...
      <section className="ticket-control">
        <p>
          Ticket inspectors check the validity of tickets both inside vehicles
          and at station platforms.
        </p>
        <div className="controle">
          <p>
            The ticket inspector is required to carry a badge with four-digit
            and a service certification with the same four-digit number.
          </p>
          ...
          <p>
            The additional charge for travelling without valid ticket you will
            be charged a fee of 1000 CZK, the fee can be paid by credit, debit
            card or cash. After the payment you will get the receive of the
            payment.
          </p>
          <div className="control-section">
            <h3>Receipt</h3>
